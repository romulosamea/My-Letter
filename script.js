const letters = {
    1: {
        ...
        content: `
            ...
            <p>A Letter of A Deep Regret and Apology June 14, 2025. September 2025.</p>
        `
    },
...
const wordDefinitions = {
    ...
    forgettable: "Adjective: Easily forgotten, especially through being uninteresting or medicore. Kanang naka limot rajud ko sa imong gi ingon maong sege kog chat sa imo nya nakay ginabuhat, nya nasamokan najud ka. I know na sulti rato nimo tungod jud saka lagot nimo sa ako, sorry kung na bother tika, pero....",
    ...
    normal: "Sorry kaayo uy, pwede back to normal na without knowing everyone? naranasan ra ko na sa imo, pero we can forgive someone naman diba?, Sorry. Di nako mag segeg samok samok, pero.....",
    ...
    misconceptions: "A view or opinion that is incorrect because based on faulty thinking or understanding. Like parihas sa imong gi ingon Creepy ko sakit sad sa part nako, bisan ka pila na nako e limot mo balik jud, di man sa di ta kabalo mag hilom no wata kabalo nga ga balik-balik day sa huna-huna sa tao ang gina ingon nimo, so unsa maka baba ug morale diba?, dali ra kayo e sulti ang Move on pero ana rajud ay ka dali, dili man tanan sad maka buhat ana labi nag na mali ra, goods man ta ka.",
    ...
    different: "kana bitawng ma pansin tika nga murag ga dali kag lakaw, nya ma remember nako tong gi ingon sa imong ig-agaw nga na hadlok daw ka, pero ngano jud diay? wala man jud koy bad intentions sa imo, pwede ma clear na? Ayaw ka hadlok gel, di man nako kailangan e prove para lang jud, maong sorry na.",
    obssesed: "I mean: Dili man kaayo ko obssesed sa imo jud kuan, kanang gamay ra as in gamay nya ikaw grabi rajud maka ingon, sa mga typings raman jud nako ka na suko, mao ranay gi amin nako sa imo, pero wala man ang feelings kay ma foul ko ana diba, nya mang basted jud diay?, pataka rakag pang busted OA sad kayo ka sa bagay babae man so OA jud, nonesense. ",
    ...
    surprised: "What I mean is: Na kalitan ra guro ka maong na ing ana imong na ingon?, pero kabalo man ka nga ga jokes ko usahay diba? maong sorry kayo.  Di biya sad ko bata kung magka gusto sa tao, ma remember man gud nako kung unsa ka pag sa chat man gud. Dili lang gud ta palabig ka OA, yes nasuko ka sa akoa that time.",
